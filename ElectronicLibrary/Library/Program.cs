...
namespace Library
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            static void AddMainComands(AppContext db)
            {
            ...
            static void ChooseComand(AppContext db,UserRepository user,BookRepository book, SelectRepository select)
            {
                Console.Write("\nВведите команду: ");
                ...
                switch (comand)
                {
                    ...
                    case nameof(Comands.ex8):
                        ...
                        break;
                    case nameof(Comands.ex9):
                        select.ExecuteEx9(db);
                        break;
                    default:
